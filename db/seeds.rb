...
bikes_data = [
  {
    ...
    status: :published,
    variants: [
      { name: "Standard", color: "Pearl Igneous Black", ex_showroom_price: 74_536, insurance: 4_200, rto: 8_500, handling_charge: 1_500, accessories_charge: 3_000 },
      { name: "DLX", color: "Decent Blue Metallic", ex_showroom_price: 76_536, insurance: 4_300, rto: 8_700, handling_charge: 1_500, accessories_charge: 3_500 }
    ],
  ...
  },
  {
    ...
    status: :published,
    variants: [
      { name: "Drum", color: "Athletic Blue Metallic", ex_showroom_price: 69_990, insurance: 3_800, rto: 7_800, handling_charge: 1_500, accessories_charge: 2_500 },
      { name: "Disc", color: "Black", ex_showroom_price: 72_990, insurance: 4_000, rto: 8_100, handling_charge: 1_500, accessories_charge: 2_800 }
    ],
  ...
  },
  {
    ...
    status: :published,
    variants: [
      { name: "Drum", color: "Matte Axis Gray Metallic", ex_showroom_price: 84_990, insurance: 4_500, rto: 9_200, handling_charge: 1_500, accessories_charge: 3_000 },
      { name: "Disc", color: "Pearl Spartan Red", ex_showroom_price: 87_990, insurance: 4_700, rto: 9_500, handling_charge: 1_500, accessories_charge: 3_200 }
    ],
...
[
  ...
  { title: "Easy Finance", subtitle: "Low EMI options available", section: "hero", position: 2 }
].each do |attrs|
